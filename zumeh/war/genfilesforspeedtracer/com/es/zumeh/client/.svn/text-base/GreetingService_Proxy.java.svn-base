...
public class GreetingService_Proxy extends RemoteServiceProxy implements com.es.zumeh.client.GreetingServiceAsync {
  private static final String REMOTE_SERVICE_INTERFACE_NAME = "com.es.zumeh.client.GreetingService";
  private static final String SERIALIZATION_POLICY ="5629DFF26FAEFE2A7B97DCE998BFCAF4";
  private static final com.es.zumeh.client.GreetingService_TypeSerializer SERIALIZER = new com.es.zumeh.client.GreetingService_TypeSerializer();
